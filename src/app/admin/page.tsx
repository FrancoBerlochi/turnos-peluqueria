    ...
    <div className="min-h-screen bg-[#FAF9F6] font-sans text-[#2A2A2A]">
      ...
      {isNavOpen && (
        <button
          ...
          className="fixed top-3 right-6 md:right-8 z-50 flex items-center justify-center p-1 rounded-full bg-[#1A1A1A] border-2 border-[#D4D4D8] shadow-2xl transition-all duration-300 hover:scale-105 cursor-pointer animate-in zoom-in-75 duration-200"
          title="Cerrar menú"
